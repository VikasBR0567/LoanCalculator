...
<%@ page import="org.bouncycastle.util.encoders.Base64"%>
				 ...
				 <input  name="image" type="image" src="profile_pic.jsp?id=<%=i%>&type=<%="user"%>" style="width:200px; height:200px;"/></div></td>
					...
					<tr>
					  <td  width="150" height="48" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Name</div></td>
	  <td  width="168" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s1);%></div></td>
					</tr>
					<tr>
					  <td  width="150" height="48" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">E-Mail</div></td>
					  <td  width="168" valign="middle" height="48" ><div align="left" class="style11" style="margin-left:20px;"><%out.println(s2);%></div></td>
					</tr>
					<tr>
					  <td  width="150" height="51" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Mobile</div></td>
					  <td  width="168" valign="middle" height="51"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s3);%></div></td>
					</tr>
					<tr>
<td  width="150" height="46" align="left" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Date Of Birth</div> </td>                    	
<td  width="168" align="left" valign="middle" height="46"><div align="left" class="style11" style="margin-left:20px;"><%out.println(s4);%></div></td>
					...
					<tr>
					  <td  width="150" height="59" align="left" valign="middle" bgcolor="#FFFF00" style="color: #00CC99;"><div align="left" class="style14 style7 style8" style="margin-left:20px;">Address</div></td>
         ...
         <%if(back.equalsIgnoreCase("allusers")){%>
            <p align="right"><a href="allusers.jsp" class="style8">Back</a></p>
			<%}
			else{%>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><a href="userlogin.jsp">View Users and Authorize </a></li>
