...
<%
					...
					if ( rs1.next() )
					   ...
					   {
							PreparedStatement ps=connection.prepareStatement("insert into user(username,password,email,mobile,dob,gender,address,pincode,status,image,nattempt) values(?,?,?,?,?,?,?,?,?,?,?)");
