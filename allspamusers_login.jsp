...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		try 
		{
				...
				String sql3="select distinct(username) from account_status where acc_type='spam account'";
			   ...
			   while(rs3.next())
			   {
				...
				%>
				 <tr>
				   <td width="95" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style8"><strong>Id</strong></div></td> 
				 <td width="188" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style12">User Image</div></td>
				<td width="158" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style12">User Name</div></td>
		   </tr>
				<%}
		 		 ...
		 		 <td width="158" valign="middle" height="65" style="color:#000000;"> <a href="spamu_behavior.jsp?name=<%=s1%>" >
		 		   <div align="center">
		 		     <%out.println(s1);%>
	 		       </div></td>
						</tr>
