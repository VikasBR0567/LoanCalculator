...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3 style8">  All Friend List </span></h2>
          <p class="infopost"><a href="#" class="com"></a></p>
          <div class="clr"></div>
          <div class="img"></div>
		  <table width="314" align="left"  cellpadding="0" cellspacing="0"  >
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
	...
	try 
	{
		...
		%>
		<tr> 
			<td width="151" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style9">Profile Picture</div></td>
		   <td width="98" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style9">Friend Name</div></td>
		   <td width="63" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center"></div></td>
		</tr>
		<%
		}
	...
	%>
        ...
        <span>
        <p align="right"><a href="usermain.jsp" class="style8">Back</a></p></span> <a href="#"></a> <a href="#"></a></p>
      </div>
      <div class="sidebar">
        <div class="gadget">
