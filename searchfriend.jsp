...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3 style8"> Search Friends </span></h2>
		  ...
		  <form id="form1" name="form1" method="post" action="searchresults.jsp">
            <tr>
              <td><span class="style10">Enter Search Keyword </span></td>
              <td>
                  <input type="text" name="key" />
              </td>
              <td>
                  <input name="Submit" type="submit" class="style10" value="Search" />
              </td>
            </tr>
		    </form>
			  <%
