...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span class="style3 style8"> Search Results </span></h2>
...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		<%
			...
			<tr>
             ...
             <tr> <td width="50" height="65" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style10">Name</div></td>
			 <td width="94" valign="middle" height="65" style="color:#000000;">&nbsp;&nbsp;
               <%out.println(s1);%></td></tr>
				   <tr>
				    <td width="50" height="26" valign="middle" bgcolor="#FFFF00" style="color:#000000;"><div align="center" class="style10">Status</div></td>
              <%
              ...
              <%
						...
						%>
              <td  width="31" valign="middle" height="26" style="color:#000000;"align="center"><a href="updaterequest.jsp?username=<%=s1%>&id=<%=i%>&fname=<%=fname%>"><%=status %>&nbsp;</a></td>
              <%}
						%>
            </tr>
            <%
					...
					{
					%>
					<h3 class="style9"> No results found </h3>
					<%}
        ...
        <p align="right"><a href="searchfriend.jsp" class="style8">Back</a></p><span></span> <a href="#"></a> <a href="#"></a></p>
      </div>
      <div class="sidebar">
        <div class="gadget">
