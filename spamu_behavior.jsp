...
<%@ page import="java.text.SimpleDateFormat, java.util.Date"%>
		...
		try 
		{
			   ...
			   while(rs3.next())
			   {
				...
				%>
				 <tr>
				   <td width="47" valign="middle" style="color:#000000;"><div align="center" class="style9"><strong>Id</strong></div></td> 
				
				<td width="164" valign="middle" height="65" style="color:#000000;"><div align="center" class="style11">Login Date</div></td>
				<td width="163" valign="middle" height="65" style="color:#000000;"><div align="center" class="style11">Logout Date</div></td>
				<td width="163" valign="middle" height="65" style="color:#000000;"><div align="center" class="style11">Activity Details</div></td>
		   </tr>
				<%}
				...
				<tr>
				  ...
				  <td width="130" valign="middle" height="65" style="color:#000000;"> <a href="spamuserbehavior.jsp?id=<%=j%>&name=<%=name%>"><div align="center">View Activity Sequence</div></a></div></td>
				</tr>
        ...
        <div class="article">
          <h2 align="right"><a href="allspamusers_login.jsp" class="style8 style10">Back</a></h2>
          <div class="clr"></div>
          <div class="clr"></div>
        </div>
